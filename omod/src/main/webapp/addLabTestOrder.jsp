...
<link
	...
	rel="stylesheet" />
<link
	href="/openmrs/moduleResources/commonlabtest/css/waitMe.min.css"
	rel="stylesheet" />	
...
<body  id= "container">
    ...
    <fieldset class="scheduler-border" style="margin-top:320px;">
        ...
        <c:if test="${not empty labTest.labReferenceNumber}">
          <openmrs:require privilege="Edit CommonLabTest Orders" otherwise="/login.htm" redirect="/module/commonlabtest/addLabTestRequest.form" />
            <legend class="scheduler-border">
        ...
        <form:form commandName="labTest" id="labTestForm" onsubmit="return validate()">
            ...
            <div class="row">
                <div class="col-md-3">
                    <form:label class="control-label" path="order.encounter">
                        <spring:message code="general.encounter" /><span class=" text-danger required">*</span></form:label>
                </div>
                <div class="col-md-6">
                    <c:if test="${not empty labTest.labReferenceNumber}">
            ...
            <div class="row">
                <div class="col-md-3">
                    <form:label class="control-label" path="labTestType.labTestTypeId">
                        <spring:message code="general.testType" /><span class="text-danger required">*</span></form:label>
                </div>
                <div class="col-md-6">
                    <c:if test="${not empty labTest.labReferenceNumber}">
                        <form:input class="form-control" path="labTestType.labTestTypeId" id="testType" hidden="true"
                            name="testType"></form:input>
            ...
            <div class="row">
                <div class="col-md-3">
                    <form:label class="control-label" path="labReferenceNumber">
                        <spring:message code="commonlabtest.order.labReferenceNo" /><span class="text-danger required">*</span></form:label>
                </div>
                <div class="col-md-6">
                    <form:input class="form-control" maxlength="100" path="labReferenceNumber" id="labReferenceNumber"
            ...
            <div class="row">
                <div class="col-md-3">
                    <form:label class="control-label" path="order.CareSetting.careSettingId">
    ...
    <openmrs:hasPrivilege privilege="Delete CommonLabTest Orders">
        <c:if test="${not empty testOrder.labReferenceNumber}">
            <fieldset class="scheduler-border">
                ...
                <form method="post" action="${pageContext.request.contextPath}/module/commonlabtest/voidlabtestorder.form"
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            ...
                            <label class="control-label" path="voidReason">
                                <spring:message code="general.reason" /><span class=" text-danger required">*</span></label>
                        </div>
                        <div class="col-md-6">
